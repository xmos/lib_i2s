...
static void i2s_he_slave_init_ports(
...
static void i2s_he_slave_send(client i2s_he_callback_if i2s_i,
        out buffered port:32 (&?p_dout)[num_out],
...
#define i2s_he_slave i2s_he_slave0

static void i2s_he_slave0(client i2s_he_callback_if i2s_i,
        out buffered port:32 (&?p_dout)[num_out],
    ...
    unsigned port_time;
    i2s_he_slave_init_ports(p_dout, num_out, p_din, num_in, p_bclk, p_lrclk, bclk);
    ...
    while(1){
        ...
        i2s_he_slave_send(i2s_i, p_dout, num_out, 1);
        ...
        while(restart == I2S_NO_RESTART){
            ...
            i2s_he_slave_receive(i2s_i, p_din, num_in, 0);

            i2s_he_slave_send(i2s_i, p_dout, num_out, 0);


            i2s_he_slave_receive(i2s_i, p_din, num_in, 1);
...
// i2s_he_slave0,it should never be called.
inline void i2s_he_slave1(client i2s_he_callback_if i2s_i,
        out buffered port:32 (&?p_dout)[num_out],
        static const size_t num_out,
        in buffered port:32 (&?p_din)[num_in],
        static const size_t num_in,
...
if (isnull(p_dout) && isnull(p_din)) {
  ...
  i2s_he_slave0(i2s_i, p_dout, num_out, p_din, num_in, p_bclk, p_lrclk, bclk);
}
