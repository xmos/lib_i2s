...
static void i2s_frame_slave_send(client i2s_frame_callback_if i2s_i,
        out buffered port:32 (&?p_dout)[num_out],
...
static void i2s_frame_slave_receive(client i2s_frame_callback_if i2s_i,
        in buffered port:32 (&?p_din)[num_in],
...
static void i2s_frame_slave0(client i2s_frame_callback_if i2s_i,
    ...
    while(1){
        ...
        i2s_frame_slave_send(i2s_i, p_dout, num_out, 1);
        ...
        while(restart == I2S_NO_RESTART){
            ...
            i2s_frame_slave_receive(i2s_i, p_din, num_in, 0);

            i2s_frame_slave_send(i2s_i, p_dout, num_out, 0);


            i2s_frame_slave_receive(i2s_i, p_din, num_in, 1);
